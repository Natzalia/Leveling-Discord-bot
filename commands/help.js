...
const prefix = config.prefix
    ...
    let help = new MessageEmbed()
      ...
      .addFields(
        { name: `Leveling Command`, value: `\`${prefix}leaderboard\`, \`${prefix}rank\``, inline: true},
      )
      .addFields(
        { name: `Configuration Command`, value: `\`${prefix}set-prefix\`, \`${prefix}set-level\`, \`${prefix}remove-level\`, \`${prefix}role-level\`, \`${prefix}add-level\``, inline: false},
      )
      .setTimestamp()
      .setFooter('© Glow Nation');
